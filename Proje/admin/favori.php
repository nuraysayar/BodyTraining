...
?>
    <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Favoriler</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Kullanıcı Favorileri</li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="" width="100%" cellspacing="0" >
                                        <?php
                                        $sorgu=$baglanti->prepare(query: "SELECT * FROM favoriler");
                                        $sorgu->execute();
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?=$sonuc["id"]?></td>
                                                <td><?=$sonuc["kullanici_adi"]?>
                                                </td>
                                                <td><?=$sonuc["antrenman_id"]?></td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="favorisil.php?id=<?=$sonuc["id"]?> &tablo=onecikanlar" class="btn btn-danger">Sil</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
